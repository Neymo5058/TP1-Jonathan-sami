...
export const useProductStore = defineStore('product', {
  state: () => ({
    // initialize from localStorage or fallback to default list
    products: JSON.parse(localStorage.getItem(STORAGE_KEY) || 'null') || [
      { id: 1, name: 'ProFit Bottle', price: 30, quantity: 50, image: 'bottle.jpg' },
      { id: 2, name: 'Simple Cap ', price: 40, quantity: 20, image: 'cap1.jpg' },
      { id: 3, name: 'Urban Cap ', price: 45, quantity: 30, image: 'cap2.jpg' },
      {
        id: 4,
  ...
  actions: {
    // write current products to localStorage
    persist() {
